...
class Lesson extends Model {
  ...
  LessonModelIdentifier get modelIdentifier {
    return LessonModelIdentifier(id: id);
  }
  ...
  Lesson copyWith(
      {String? name, String? description, String? video, String? sectionID}) {
    return Lesson._internal(
        id: id,
        name: name ?? this.name,
  ...
  static final QueryModelIdentifier<LessonModelIdentifier> MODEL_IDENTIFIER =
      QueryModelIdentifier<LessonModelIdentifier>();
...
class LessonModelIdentifier implements ModelIdentifier<Lesson> {
  ...
  const LessonModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is LessonModelIdentifier && id == other.id;
  }
