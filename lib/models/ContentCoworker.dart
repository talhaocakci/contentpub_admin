...
class ContentCoworker extends Model {
  ...
  ContentCoworkerModelIdentifier get modelIdentifier {
      return ContentCoworkerModelIdentifier(
        id: id
      );
  }
  ...
  const ContentCoworker._internal({required this.id, required coworker, required content, createdAt, updatedAt}): _coworker = coworker, _content = content, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory ContentCoworker({String? id, required Coworker coworker, required Content content}) {
  ...
  String toString() {
    ...
    buffer.write("id=" + "$id" + ", ");
    buffer.write("coworker=" + (_coworker != null ? _coworker!.toString() : "null") + ", ");
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'coworker': _coworker?.toJson(), 'content': _content?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'coworker': _coworker, 'content': _content, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<ContentCoworkerModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<ContentCoworkerModelIdentifier>();
 ...
 */
@immutable
class ContentCoworkerModelIdentifier implements ModelIdentifier<ContentCoworker> {
  final String id;

  /** Create an instance of ContentCoworkerModelIdentifier using [id] the primary key. */
  const ContentCoworkerModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is ContentCoworkerModelIdentifier &&
      id == other.id;
  }
