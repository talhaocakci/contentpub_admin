...
class Bundle extends Model {
  ...
  factory Bundle(
    ...
    return Bundle._internal(
        ...
        isFree: isFree,
        contents:
            contents != null ? List<Content>.unmodifiable(contents) : contents,
      ...
      : id = json['id'],
        ...
        _contents = json['contents'] is List
            ? (json['contents'] as List)
                .where((e) => e != null)
                .map((e) => Content.fromJson(new Map<String, dynamic>.from(e)))
                .toList()
            : json['contents']['items'] is List
                ? (json['contents']['items'] as List)
                    .where((e) => e != null)
                    .map((e) =>
                        Content.fromJson(new Map<String, dynamic>.from(e)))
                    .toList()
                : null,
  ...
  Map<String, dynamic> toJson() => {
        ...
        'isFree': _isFree,
        'contents': _contents?.map((Content? e) => e?.toJson()).toList(),
