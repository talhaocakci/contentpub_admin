...
class Bundle extends Model {
  ...
  BundleModelIdentifier get modelIdentifier {
    return BundleModelIdentifier(id: id);
  }
  ...
  const Bundle._internal(
      ...
      : _name = name,
        ...
        _isAllCourses = isAllCourses,
        _isAllDocuments = isAllDocuments,
  ...
  factory Bundle(
    ...
    return Bundle._internal(
        ...
        contents: contents != null
            ? List<BundleContent>.unmodifiable(contents)
            : contents,
  ...
  String toString() {
    ...
    buffer.write(
        "isFree=" + (_isFree != null ? _isFree!.toString() : "null") + ", ");
    buffer.write("isAllAccess=" +
        (_isAllAccess != null ? _isAllAccess!.toString() : "null") +
        ", ");
    buffer.write("stripeProductId=" + "$_stripeProductId" + ", ");
    buffer.write("isAllCourses=" +
        (_isAllCourses != null ? _isAllCourses!.toString() : "null") +
        ", ");
    buffer.write("isAllDocuments=" +
        (_isAllDocuments != null ? _isAllDocuments!.toString() : "null") +
        ", ");
    buffer.write("isPublished=" +
        (_isPublished != null ? _isPublished!.toString() : "null") +
        ", ");
    buffer.write("isArchived=" +
        (_isArchived != null ? _isArchived!.toString() : "null") +
        ", ");
  ...
  Map<String, dynamic> toJson() => {
        ...
        'isFree': _isFree,
        'contents': _contents?.map((BundleContent? e) => e?.toJson()).toList(),
        'prices': _prices?.map((Price? e) => e?.toJson()).toList(),
        'isAllAccess': _isAllAccess,
        'stripeProductId': _stripeProductId,
        'isAllCourses': _isAllCourses,
        'isAllDocuments': _isAllDocuments,
  ...
  static final QueryModelIdentifier<BundleModelIdentifier> MODEL_IDENTIFIER =
      QueryModelIdentifier<BundleModelIdentifier>();
  ...
  static final QueryField PRICES = QueryField(
      fieldName: "prices",
      fieldType:
          ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'Price'));
  ...
  static final QueryField ISALLDOCUMENTS =
      QueryField(fieldName: "isAllDocuments");
...
class BundleModelIdentifier implements ModelIdentifier<Bundle> {
  ...
  const BundleModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is BundleModelIdentifier && id == other.id;
  }
