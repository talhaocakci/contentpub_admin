                      ...
                      child: GridView.count(
                        ...
                        children: [
                          ElevatedButton(
                              ...
                              child:
                                  const Text('Select from existing bundles')),
                          ElevatedButton(
                              style: const ButtonStyle(
                                  alignment: Alignment.topCenter),
                              onPressed: () {
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  print('bundle save edildi. id: ${bundle.id}');
...
Future<List<Bundle>> getBundles() async {
  try {
    String graphQLDocument = '''query ListBundles {
  listBundles {
    nextToken
    startedAt
    items {
    ...
    var json = jsonDecode(data!)['listBundles']['items'] as List;

    List<Bundle> list = json.map((e) => Bundle.fromJson(e)).toList();

    for (Bundle b in list) {
      print(b.name);
    }
